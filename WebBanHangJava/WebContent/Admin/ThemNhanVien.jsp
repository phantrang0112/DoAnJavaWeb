                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-3 c-form-box wow fadeInUp">
                        <div class="c-form-bottom">
                            ...
                            <form role="form" action="<c:url value="DetailAccountAdmin?task=insertAdmin"/>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtemail" placeholder="Số lượng" class="c-form-name form-control" id="c-form-name">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtsdt" placeholder="Giá" class="c-form-email form-control" id="c-form-email">
                                </div>
