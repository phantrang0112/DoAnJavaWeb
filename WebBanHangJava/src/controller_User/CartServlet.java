...
import model_User.CartModel;
import model_User.ChiTietHoaDonModel;
import model_User.HoaDonModel;
...
//				Calendar calendar= Calendar.getInstance();
		...
		tong=cartModel.totallist();
		System.out.println(tong+"tongtien");
		hoaDonModel.updateTongTien(newesthoadon, tong);
